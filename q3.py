...
# def find(self) -> Self: finds this User's root / representative node (the "find" step in the union-find algorithm)
# def union(self, other: Self) -> None: combines the sets containing this node and other into a single set (the "union" step of the union-find algorithm)
